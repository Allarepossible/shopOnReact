const initialState = [
        ...
        products: [
            {
                ...
                ratio: 3,
                nalichie: 'В наличии',
                info: 'Планшет Galaxy Tab A 10.1, Micro-SIM, Android 4.4, 3G' +
                ' Bluetooth 4.0, EDGE, GPRS, WAP, Wi-Fi, ' +
                'Количество ядер процессора 4, Частота процессора 1400 МГц...',
                price: 12382,
            }, {
                ...
                ratio: 5,
                nalichie: 'В наличии',
                info: 'Смартфон Microsoft Lumia 640 Dual SIM (RM-1077) С ним вы открываете мир ярких цифровых' +
                ' ' +
                'возможностей. Этот многофункциональный смартфон уже содержит набор бесплатных сервисов Microsoft...',
                price: 9823,
            }, {
                ...
                ratio: 4,
                nalichie: 'В наличии',
                info: 'Смартфон Archos 50 Oxygen Plus, серый. Моноблок, Micro-SIM, Android , 3G, Bluetooth,' +
                ' ' +
                'USB-подключение к ПК, Wi-Fi, Разрешение основной камеры 8 Мп...',
                price: 8263,
            }, {
                name: 'Lenovo TAB 2',
                id: 4,
                ...
                ratio: 2,
                nalichie: 'В наличии',
                info: 'Смартфон Philips S398 Black. Черный корпус и разнообразие цветных панелей для ' +
                'Philips S398 как нельзя лучше подчеркнут ваш статус и уверенность в себе. Преимущества этой модели...',
                price: 12932,
            }, {
                ...
                ratio: 4,
                nalichie: 'В наличии',
                info: 'Смартфон Microsoft Lumia 430 RM-1099 black Куда бы вы ни направлялись, смартфон должен быть' +
                ' ' +
                'надежным спутником. Поэтому у Microsoft Lumia 430 Dual SIM (RM-1099) удобный компактный корпус ...',
                price: 5632,
            }, {
                ...
                ratio: 1,
                nalichie: 'В наличии',
                info: 'Смартфон Senseit L301 black, черный. Micro-SIM, две поддерживаемых SIM-карты, Android, ' +
                '3G, GPS-модуль...  ',
                price: 6241,
            },
        ],
        ...
        products: [
            {
                ...
                ratio: 2,
                nalichie: 'В наличии',
                info: 'Смартфон Philips S398 Black. Черный корпус и разнообразие цветных панелей для Philips' +
                ' S398 как нельзя лучше подчеркнут ваш статус и уверенность в себе. Преимущества этой модели...',
                price: 12990,
            }, {
                ...
                ratio: 1,
                nalichie: 'В наличии',
                info: 'Смартфон Senseit L301 black, черный. Micro-SIM, две поддерживаемых SIM-карты, Android, 3G,' +
                ' GPS-модуль...  ',
                price: 4990,
            }, {
                ...
                ratio: 5,
                nalichie: 'В наличии',
                info: 'Смартфон HIGHSCREEN WinWin Black оснащен 4 дисплеем и двумя слотами для SIM-карт.' +
                '  Windows' +
                ' Phone , 3G, Bluetooth,' +
                ...
                ratio: 4,
                nalichie: 'В наличии',
                info: 'Смартфон Alcatel OT4013D PIXI 3 (2 SIM). Смартфон Alcatel One Touch 4013D оснащен' +
                ' четырехдюймовым дисплеем и двумя слотами для SIM-карт.' +
                '..',
                price: 3892,
            }, {
                ...
                ratio: 3,
                nalichie: 'В наличии',
                info: 'Смартфон Fly IQ434 Era Nano 5 оснащен 3.5 дисплеем и двумя слотами для SIM-карт.' +
                ' Android 2.3, Micro SD, Wi-Fi.... ',
                price: 1790,
            }, {
        ...
        products: [
            {
                ...
                ratio: 2,
                nalichie: 'В наличии',
                info: 'Смартфон Philips S398 Black. Черный корпус и разнообразие цветных панелей для Philips S398' +
                ' как нельзя лучше подчеркнут ваш статус и уверенность в себе. Преимущества этой модели...',
                price: 4928,
            }, {
        ...
        filters: [
            {
                ...
                id: 'color',
                type: 'color',
                values: ['white', 'gray', 'black', 'yellow', 'orange', 'green', 'skyblue', 'violet', 'pink', 'brown'],
                reset: true,
            }, {
                name: 'Операционная система',
                open: 'yes',
        ...
        filters: [
            {
                ...
                id: 'color',
                type: 'color',
                values: ['white', 'gray', 'black', 'blue', 'red', 'yellow', 'skyblue', 'violet', 'pink', 'brown'],
                reset: true,
            }, {
                name: 'Операционная система',
                open: 'yes',
    ...
    },
    {
        ...
        id: 'laptop',
        name: 'Ноутбуки',
        img: 'images/img/laptop/Apple-MacBook-Air-13-1.jpeg',
        products: [
            {
                ...
                catalog: 'laptop',
                images: [
                    {image: 'images/img/laptop/Apple-MacBook-Air-13-1.jpeg'},
                    {image: 'images/img/laptop/Apple-MacBook-Air-13-2.jpeg'},
                    {image: 'images/img/laptop/Apple-MacBook-Air-13-3.jpeg'},
                ],
                activeIndex: 0,
                date: 124325,
                articul: 6000,
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/ASUS-VivoBook-Max-1.jpeg'},
                    {image: 'images/img/laptop/ASUS-VivoBook-Max-2.jpeg'},
                    {image: 'images/img/laptop/ASUS-VivoBook-Max-3.jpeg'},
                ],
                articul: 6001,
                oc: 'WindowsPhone',
                brands: 'Microsoft',
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/DELL-INSPIRON-5567-1.jpeg'},
                    {image: 'images/img/laptop/DELL-INSPIRON-5567-2.jpeg'},
                    {image: 'images/img/laptop/DELL-INSPIRON-5567-3.jpeg'},
                ],
                articul: 6002,
                oc: 'Android',
                brands: 'Archos',
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/Lenovo-IdeaPad-AMD-1.jpeg'},
                    {image: 'images/img/laptop/Lenovo-IdeaPad-AMD-2.jpeg'},
                    {image: 'images/img/laptop/Lenovo-IdeaPad-AMD-3.jpeg'},
                ],
                articul: 6003,
                oc: 'Android',
                brands: 'Philips',
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/DELL-Vostro-5468-1.jpeg'},
                    {image: 'images/img/laptop/DELL-Vostro-5468-2.jpeg'},
                    {image: 'images/img/laptop/DELL-Vostro-5468-3.jpeg'},
                ],
                articul: 6004,
                oc: 'WindowsPhone',
                brands: 'Microsoft',
                ...
                color: 'black',
                images: [
                    {image: 'images/img/laptop/MSI-GP72-7RD-Leopard-1.jpeg'},
                    {image: 'images/img/laptop/MSI-GP72-7RD-Leopard-2.jpeg'},
                    {image: 'images/img/laptop/MSI-GP72-7RD-Leopard-3.jpeg'},
                ],
                articul: 6005,
                feature: [
                    {name: 'Тип SIM-кары', value: 'Micro-SIM'},
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/HP-ProBook-430-G4-1.jpeg'},
                    {image: 'images/img/laptop/HP-ProBook-430-G4-2.jpeg'},
                    {image: 'images/img/laptop/HP-ProBook-430-G4-3.jpeg'},
                ],
                articul: 6006,
                oc: 'Windows Phone',
                brands: 'WinWin',
                ...
                date: 124325,
                images: [
                    {image: 'images/img/laptop/Sony-VAIO-Pro-1.jpeg'},
                    {image: 'images/img/laptop/Sony-VAIO-Pro-2.jpeg'},
                    {image: 'images/img/laptop/Sony-VAIO-Pro-3.jpeg'},
                ],
                articul: 6007,
                oc: 'Android',
                brands: 'Alcatel',
        ...
        filters: [
            {
                ...
                id: 'color',
                type: 'color',
                values: ['white', 'gray', 'black', 'blue', 'red', 'green', 'skyblue', 'violet', 'pink', 'brown'],
                reset: true,
            }, {
                name: 'Операционная система',
                open: 'yes',
        ...
        filters: [
            {
                ...
                id: 'color',
                type: 'color',
                values: ['white', 'gray', 'black', 'blue', 'red', 'yellow', 'orange', 'green', 'skyblue', 'brown'],
                reset: true,
            }, {
                name: 'Операционная система',
                open: 'yes',
        ...
        filters: [
            {
                ...
                id: 'color',
                type: 'color',
                values: ['white', 'gray', 'black', 'blue', 'red', 'yellow', 'orange', 'skyblue', 'violet', 'brown'],
                reset: true,
            }, {
                name: 'Операционная система',
                open: 'yes',
...
export default function catalogs(state = initialState) {
    return state;
}
